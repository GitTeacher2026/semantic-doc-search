...
- رفع PDF وOffice ونصوص **والصور** (OCR عبر Tesseract المحلي أو OCR.space السحابي)
...
محركان متاحان — اختر من القائمة فوق منطقة الرفع:

| المحرك | المفتاح | الملاحظات |
|--------|---------|-----------|
| **Tesseract** (محلي) | لا يحتاج مفتاح | مجاني، عربي + إنجليزي، أبطأ في أول مرة |
| **OCR.space** (سحابي) | `OCR_SPACE_API_KEY` | أسرع، مناسب للصور الكبيرة |

**الوضع التلقائي:** يجرب OCR.space إن وُجد المفتاح، ثم ينتقل إلى Tesseract عند الفشل.
