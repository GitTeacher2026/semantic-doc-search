...
## ملاحظات التحديث (للمسؤول)

بعد تسجيل الدخول كمسؤول يظهر زر **ملاحظات التحديث** بجانب إدارة الأعضاء. منه يمكن:

- إظهار أو إخفاء شريط «تحديثات الموقع» للمستخدمين
- تحديد سياسة ما يكتبه Cursor عند كل تعديل (اللغة، مستوى التفصيل، الفئات المسموحة، النشر التلقائي، قالب النص، والتعليمات الحرة)
- إضافة / تعديل / حذف / نشر الملاحظات يدوياً

تُحفظ الإعدادات والملاحظات في `data/site-changelog.json` عبر GitHub Contents API (مثل حسابات المستخدمين).
